...
Задание 2
Пункт 2
К сожалению я не смог запустить сборку локльно , приложу скриншоты ошибок, так и не смог понять в чм причина данной ошибки, приложил скриншоты после расшифровки файла.
...
`Скриншот-3 к заданию 2 пункт 2, gitlab-ci:
